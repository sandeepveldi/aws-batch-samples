...
# Build the image
docker build -f ./Dockerfile -t aws-batch-workshop/arrayjob:latest .

# Tag the image
docker tag aws-batch-workshop/arrayjob:latest ${ECR_URL}/aws-batch-workshop/arrayjob:latest

# Push your image to your ECR repository
docker push ${ECR_URL}/aws-batch-workshop/arrayjob:latest