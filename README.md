...
> :warning: 
> Please look out for extra white spaces or character changes when copy pasting code or text. I've tried not including "" in the text that's supposed to be copied. But please be on the look out.
